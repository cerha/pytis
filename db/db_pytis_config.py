...
_std_table_nolog('e_pytis_form_profile_params',
      ...
      sql='''UNIQUE (username, spec_name, profile_id, form_name),
             FOREIGN KEY (username, spec_name, profile_id)
             REFERENCES e_pytis_form_profiles (username, spec_name, profile_id) on delete cascade''',
      grant=db_rights,
      schemas=db_schemas,
