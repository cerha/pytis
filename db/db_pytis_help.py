...
_std_table('e_pytis_menu_help_attachments',
           doc="Attachments for help texts (images etc.)",
           columns=(PrimaryColumn('file_id', pd.Serial()),
                    Column('menuid', pd.Integer(),
                           references='e_pytis_menu(menuid) on delete cascade',
                           constraints=('NOT NULL',)),
                    #Column('page_id', pd.Integer(), references='e_pytis_help_pages(page_id) on delete cascade'constraints=('NOT NULL',)),
