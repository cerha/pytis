...
from spec import *
from defs import *
from dmp import dmp_add_member, dmp_add_form, dmp_commit, dmp_import, dmp_ls, dmp_reset_rights, dmp_update_form, dmp_delete_menu, dmp_delete_fullname, dmp_delete_shortname, dmp_convert_system_rights
