...
class Menu(Specification):
    ...
    bindings = (Binding(_("Přístupová práva"), 'cms.Rights',
...
class Users(Specification):
    ...
    bindings = (Binding(_("Uživatelské role aktivního uživatele"), 'cms.UserRoles', 'uid'),)
...
class Roles(Specification):
    ...
    bindings = (Binding(_("Uživatelé zařazení do této role"), 'cms.RoleUsers', 'role_id'),)
