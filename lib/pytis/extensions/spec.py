...
class DataSpec(object):
    ...
    def __init__(self, table, columns, key, access_rights=None,
        ...
        automaticky doplněn sloupec 'oid' typu 'lib.data.Oid'.
    ...
    def make(self):
        """Vtať instanci 'lib.data.DataFactory' odpovídající specifikaci."""
        t = self._table
        bindings = []
    ...
    def __init__(self, id, column=None, enumerator=None, type=None, **kwargs):
        ...
        Argumenty:
          ...
          enumerator -- název specifikace pro resolver (řetězec nebo None).  Z
            ...
            'lib.data.Codebook', pokud není určen explicitně (viz. níže).
...
class ReusableSpec:
    ...
    def bindings(self, *args):
        ...
        Pokud nejsou vyjmenovány žádné identifikátory sloupců, vrátí seznam
        všech sloupců.  Vrací sekvenci instancí 'lib.data.DBColumnBinding'.
