...
def context_mitem(title, handler, hotkey=None, **kwargs):
    ...
    Bude vyvolán příkaz `ListForm.COMMAND_CURRENT_ROW_ACTION', kterému budou
...
def context_rp(spec_name, proc_name, *args):
    ...
    """Vrať handler akce kontextového menu, který spustí proceduru s argumenty.
    ...
    'args'.  Args je tedy seznamem identifikátorů sloupců.

    Hodnoty jsou proceduře předány jako klíčové argumenty, kde název argumentu
    odpovídá názvu klíče.
