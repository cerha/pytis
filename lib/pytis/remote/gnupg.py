...
Modified to cooperate with gevent.
"""
...
class GPG(object):
    ...
    def _open_subprocess(self, args, passphrase=False):
        ...
        if os.name == 'posix':
            return gevent.subprocess.Popen(cmd, shell=False, stdin=PIPE, stdout=PIPE, stderr=PIPE)
        else:
            return gevent.subprocess.Popen(pcmd, shell=True, stdin=PIPE, stdout=PIPE, stderr=PIPE)
