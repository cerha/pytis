...
class LCGFormatter(object):
    ...
    def template_help(row, module):
        ...
        """
        text = u""
        text += _("""Prom�nn� pro hlavn� �ablonu:
  ${current_row.IDENTIFIK�TOR_SLOUPCE} ... vlo�en� hodnoty sloupce
  ${table} ... vlo�en� cel� tabulky
  ${data.IDENTIFIK�TOR_SLOUPCE} ... vlo�en� hodnoty v opakovan�m ��dku tabulky
