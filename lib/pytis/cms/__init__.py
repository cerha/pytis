...
Pytis CMS makes it possible to manage a web application through an ordinary
pytis fat client application.

It basically consists of two parts:

  * Pytis application for management of database structures, which define the
    behavior and content of a web application.

  * Wiking based web application, which reads these database structures,
    behaves according to them and displays the content defined by them.
