...
class BindingSpec(object):
    """Specifikace vazby dvou náhledů do duálního formuláře."""
    ...
    def __init__(self, title, binding_column, side_binding_column=None,
        ...
        Argumenty:
          ...
          sash_ratio -- poměr rozdělení plochy formulářů jako desetinné číslo v
            ...
            stejná plocha.  Menši hodnota znamená menší hlavní formulář, větší
            naopak.
...
class FieldSpec(object):
    ...
    def __init__(self, id, label='', column_label=None, descr=None,
        ...
        Argumenty:
          ...
          related_codebook_field -- Potlačený atribut.  Namísto něj, nechť je
            používán computer typu 'CbComputer'.
