...
class FieldSpec(object):
    ...
    def __init__(self, id, label='', column_label=None, descr=None,
        ...
        Argumenty:
          ...
          related_codebook_field -- specifikace vazby tohoto políčka (pro
            názornost si jej označme A) do číselníku.  Jde o dvojici
            identifikátorů sloupců (řetězců).  První identifikátor určuje
            políčko B ve stejném defsu, které je spojeno s číselníkem (jeho
            datový typ má enumerátor typu DataEnumerator).  Neurčujeme zde tedy
            přímo vlastní číselník políčka A, ale signalizujeme jeho vazbu na
            číselník políčka B.  Druhý předaný identifikátor označuje políčko C
            z datového objektu enumerátoru.  Pro políčko A bude automaticky
            vytvořen 'computer', který bude hodnotu políčka C z číselníku
            získávat a zobrazovat jako hodnotu políčka A.  Pokud je
            identifikátor C shodny s identifikátorem A, lze jej vypustit a jako
            hodnotu tohoto argumentu uvést prostý řetězec - identifikátor
            číselníkového políčka B.
