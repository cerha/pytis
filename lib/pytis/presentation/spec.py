...
class ViewSpec(object):
    ...
    def __init__(self, title, fields, layout=None, columns=None,
        ...
        Argumenty:
          ...
          description_format -- Potlačený argument.  Description nechť je vždy
            prostý text.  Podrobnější popis, který potřebuje formátování nechť
            je uváděn jako 'help'.
...
class FieldSpec(object):
    ...
    def __init__(self, id, label='', column_label=None, descr=None,
        ...
        if check is not None:
            log(OPERATIONAL,
                "Použita potlačená funkce 'check' třídy 'FieldSpec'!")
        self._id = id
        self._label = gettext_(label)
