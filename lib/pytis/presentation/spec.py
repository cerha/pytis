...
class ViewSpec(object):
    ...
    def __init__(self, title, fields, layout=None, columns=None,
        ...
        Argumenty:
          ...
          description -- popis formuláře.
          description_format -- typ popisu, jedna z konsant třídy TextFormat. 
          ...
          enable_inline_insert -- tento parametr není nadále podporován a v
            budoucnu bude zcela zrušen.  Zatím je ponechán pro zpětnou
            kompatibilitu.
        ...
        if enable_inline_insert is not None:
            log(OPERATIONAL,
                "Použit potlačený argument 'enable_inline_insert'.")
