...
class PresentedRow(object):
    ...
    def field_changed(self, key):
        ...
        Pozor: Pro plně virtuální políčka vrací vždy nepravdu!  Ani pro
        nevirtuální dopočítávaná políčka není pravdivist výsledku zaručena,
        neboť k výpočtu skutečné hodnoty nemuselo nikdy dojít.
    ...
    def set_transaction(self, transaction):
        """Nastav transakci pro předávání operacím datového objektu."""
        self._transaction = transaction

    def get_transaction(self):
        """Vrať transakci pro předání operacím datového objektu."""
