...
_LABELS = {
    ...
    'row_highlight_color':   _(u"Zvýraznění aktivního řádku"),
    'row_highlight_color_inactive': _(u"Zvýraznění aktivního řádku v neaktivním formuláři"),
