...
zaslané hlášení nebo odpoví na otázku.
...
class GenericDialog(Dialog):
    ...
    Tato třída se snaží zabezpečit univerzální dialogovou třídu, od které je
    možno odvodit specializované třídy konkrétních dialogů pomocí předefinování
    některých metod.
    ...
    def __init__(self, parent, title, buttons, default=None, report=None,
        ...
        Argumenty:
          ...
          report -- Text reportu, který má být zobrazen v okně dialogu.  Jedná
            ...
            případě je nutné toto indikovat argumentem 'html'.
          html -- boolean příznak, zda má být text reportu zobrazen jako prostý
            text, či jako HTML.  V případě, že není žádný report specifikován,
