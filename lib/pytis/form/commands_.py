...
# 	Tento Příkaz je určen k vytváření uživatelem definovaných akcí v
# 	kontextovém menu řádku BrowseFormu.
#
...
#       instance PresentedRow aktuálního řádku, nad kterým byla akce vyvolána.
#
