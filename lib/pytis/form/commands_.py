...
Command(Application, 'NOTHING',
        "Falešný příkaz, který nic nedělá.")
...
FORM_COMMAND_MENU = ((
    ...
    (InnerForm.COMMAND_RELOAD_FORM_STATE,
     ...
     _("Zahodit uživatelské nastavení formuláře během tohoto spuštění")),
...
COMMAND_ICONS = (
    ...
    (LookupForm.COMMAND_SORT(
      direction=LookupForm.SORTING_ASCENDENT),  'sort-asc'),
    (LookupForm.COMMAND_SORT(
      direction=LookupForm.SORTING_DESCENDANT), 'sort-desc'),
    (LookupForm.COMMAND_SORT(
       direction=LookupForm.SORTING_NONE),      'unsort'),
