...
COMMAND_ICONS = (
    ...
    (LookupForm.COMMAND_UPDATE_PROFILE, 'save'),
    (Application.COMMAND_HANDLED_ACTION(cmd=LookupForm.COMMAND_SAVE_NEW_PROFILE), wx.ART_COPY),
    (Application.COMMAND_HANDLED_ACTION(cmd=LookupForm.COMMAND_RENAME_PROFILE), 'edit-text'),
    (LookupForm.COMMAND_DELETE_PROFILE, 'delete'),
    (LookupForm.COMMAND_SET_INITIAL_PROFILE, 'star'),
    (LookupForm.COMMAND_RELOAD_PROFILE, 'revert-to-saved'),
