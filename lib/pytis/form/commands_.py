...
Command(ListForm, 'CONTEXT_ACTION',
        "Akce v kontextu řádkového formuláře")
...
FORM_COMMAND_MENU = ((
    ...
    (_("Zavřít aktuální okno"), Form.COMMAND_LEAVE_FORM),
    ),(#---------------
    ...
    (_("Vložit řádku pod"),     ListForm.COMMAND_INSERT_LINE()),
    (_("Vložit řádku nad"),     ListForm.COMMAND_INSERT_LINE(before=True)),
    (_("Kopírovat řádku pod"),  ListForm.COMMAND_INSERT_LINE(copy=True)),
    (_("Kopírovat řádku nad"),  ListForm.COMMAND_INSERT_LINE(copy=True,
                                                          before=True)),
