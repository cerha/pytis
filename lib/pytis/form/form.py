...
class LookupForm(InnerForm):
    ...
    def profile_context_menu(self, ctrl):
        ...
        return (
            MItem(_("Uložit"), self.COMMAND_UPDATE_SAVED_PROFILE(),
                  help=_("Aktualizovat uložený profil podle současného nastavením formuláře"),
                  hotkey='Enter'),
            MItem(_("Uložit jako nový"), self.COMMAND_SAVE_NEW_PROFILE(ctrl=ctrl),
                  help=_("Vytvořit nový profil podle současného nastavením formuláře"),
                  ),
            MItem(_("Přejmenovat"), self.COMMAND_RENAME_PROFILE(ctrl=ctrl),
