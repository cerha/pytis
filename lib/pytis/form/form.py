...
class RecordForm(Form):
    ...
    def _init_attributes(self, key=None, prefill=None, **kwargs):
        ...
        Argumenty:
          ...
          key -- sekvence hodnot klíčových sloupců aktivovaného řádku jako
            instance třídy 'pytis.data.types_.Value'.  Není-li 'None', formulář
            by se měl naplnit hodnotami získanými z datového objektu pro řádek
            dat s daným klíčem.
    ...
    def _on_new_record(self, copy=False):
        ...
        if result is not None:
            ...
            # TODO: Přidáno jako dočasné řešení, dokud nebude správně fungovat
            #       refresh sideformu po přidání záznamu.
            self.refresh()
...
class EditForm(LookupForm, TitledForm):
    ...
    def _commit_form(self, close=True):
        ...
        if success and result[1]:
            ...
            run_dialog(Error, _("Uložení záznamu se nezdařilo"))
            return False
