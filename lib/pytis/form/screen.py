    ...
    def create(self, parent, keyhandler, form=None):
        ...
        for i in self._items:
            if isinstance(i, (MItem, RadioItem)):
                ...
                # Pokud k příkazu nejsou přístupová práva, použij na místě hotkey
                # řetězec (N/A)
        ...
        while items:
            ...
            if isinstance(i, MItem):
                ...
                # Toto je zde zejména kvůli nakešování vypočtených hodnot
                # uvnitř 'Command.enabled()' při startu aplikace.
...
class CheckItem(MItem):
    ...
    def __init__(self, title, command, state=None, **kwargs):
        ...
        Arguemnty:
          ...
          state -- funkce jednoho argumentu (instance 'Application' právě
            běžící aplikace), která vrací True/False podle toho, zda je stav této
            položky 'zapnuto', nebo 'vypnuto'.
