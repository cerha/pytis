...
COMMAND_ICONS = (
    ...
    (Command(Application.raise_next_form), 'next-form'),
    (Command(Application.raise_prev_form), 'prev-form'),
    (Command(Application.raise_recent_form), 'recent-form'),
    ...
    (Command(Application.handled_action, cmd=LookupForm.save_new_profile), wx.ART_COPY),
    (Command(Application.handled_action, cmd=LookupForm.rename_profile), 'edit-text'),
