...
class InputField(object, KeyHandler, CallbackHandler, CommandHandler):
    ...
    def __init__(self, parent, spec, data, guardian=None, inline=False,
        ...
        Argumenty:
          ...
          denied -- příznak nepřístupnosti políčka z důvodu nedostatečných
            přistupových práv.  Takto znepřístupněné políčko již nelze
            zpřístupnit a vzhled je jiný, než v případě políčka zakázaného
    ...
    def set_presented_row(self, row):
        """Ulož odpovídající instanci PresentedRow."""
