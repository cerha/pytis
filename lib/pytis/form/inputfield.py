...
class InputField(object, KeyHandler, CallbackHandler, CommandHandler):
    ...
    """Voláno, pokud má být provedena navigace na další prvek ve formuláři.
    ...
    Políčka vyvolávají navigaci například k přeskočení neaktivních prvků apod,
    vlastní navigaci však zajišťuje nadřízený formulář.
...
class EnumerationField(InputField):
    ...
    def _set_value(self, value):
        ...
        # _on_change musíme volat ručně, protože SetStringSelection() nevyvolá
        # událost.
        self._on_change()
        return result
