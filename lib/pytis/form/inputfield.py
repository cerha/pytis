    ...
    def _menu(self):
        return super(TextField, self)._menu() + \
               (None,
                ...
                UICommand(TextField.COMMAND_PASTE(), _("Vložit"),
                          _("Vložit text ze schránky do políčka.")),
                UICommand(TextField.COMMAND_SELECT_ALL(), _("Vybrat vše"),
    ...
    def _menu(self):
        return super(CodebookField, self)._menu() + \
               (UICommand(self.COMMAND_INVOKE_SELECTION(alternate=True),
                          ...
                          _("Zobrazit číselník se zapnutým inkrementálním vyhledáváním.")),)
...
class ListField(GenericCodebookField):
    ...
    def _menu(self):
        return (UICommand(self.COMMAND_SELECT(), _("Vybrat"),
                ...
                UICommand(self.COMMAND_SHOW_SELECTED(), _("Najít vybranou položku"),
                          _("Nalistovat v seznamu vybranou položku.")),
                None,
                UICommand(self.COMMAND_INVOKE_CODEBOOK_FORM(), _("Zobrazit číselník"),
                          _("Otevřít číselníkový formulář.")),
                ...
                UICommand(self.COMMAND_DELETE_SELECTED(), _("Smazat vybraný záznam"),
                          _("Vymazat vybraný záznam z číselníku.")),
                UICommand(self.COMMAND_NEW_CODEBOOK_RECORD(), _("Vložit nový záznam do číselníku"),
                          _("Otevřít formulář pro vložení nového záznamu do číselníku.")),
                UICommand(Application.COMMAND_RUN_FORM(form_class=BrowseForm,
                                                       name=self._cb_name,
                                                       select_row=self._select_row_arg()),
                          _("Zobrazit celou tabulku"),
                          _("Otevřít náhled číselníku v samostatném řádkovém formuláři.")),
                )
    ...
    def _menu(self):
        ...
        return super(Invocable, self)._menu() + \
               (None,
                ...
                UICommand(FileField.COMMAND_SAVE(), _("Uložit do souboru"),
