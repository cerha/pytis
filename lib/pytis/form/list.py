...
#         sizer.Layout()
    ...
    def _aggregation_menu(self):
        return [CheckItem(label, command=ListForm.COMMAND_TOGGLE_AGGREGATION(operation=op),
                ...
                [MSeparator(),
                 MItem(self._aggregations and _("Zrušit vše") or _("Zobrazit vše"),
    ...
    def _refresh(self, when=None, reset=None):
        ...
        Argumenty:
          ...
          reset -- určuje, které parametry zobrazení mají být zachovány a které změněny.  Hodnotou
            ...
            podmínka i třídění.  Je-li hodnotou prázdné dictionary, jsou naopak oba tyto parametry
            resetovány na své počáteční hodnoty.  Jinak jsou resetovány právě ty parametry, pro něž
