...
#                    prefill[k] = the_row[k].value()
    ...
    def _on_delete_record(self, key):
        ...
        if deleted:
            ...
            #       Uděláme raději refresh celého formuláře na vrcholu
            #       zásobníku, protože jinak se nerefreshne horní formulář
...
class BrowseForm(ListForm):
    ...
    def on_command(self, command, **kwargs):
        if command == Form.COMMAND_PRINT and kwargs.get('form') is self:
