...
class CommandHandler:
    ...
    TODO: Doplnit přehled účelu jednotlivých metod.
    ...
    def invoke_command(cls, command, **kwargs):
        ...
        Vrací pravdu, pokud je handler nalezen, příkaz je zpracován a nemají
        tedy již být prováděny další pokusy o jeho zpracování.
    ...
    def on_command(self, command, **kwargs):
        ...
        Argumenty:
          ...
          kwargs -- argumenty příkazu 'command'
        ...
        V každé odvozené třídě, která definuje vlastní příkazy, by tato metoda
        měla být předefinována a měla by ošetřovat všechny tyto příkazy.  
...
class Command(object):
    ...
    def invoke(self, **kwargs):
        ...
        if self.enabled(**kwargs):
            ...
            log(EVENT, 'Zamítnuto vyvolání příkazu:', (self, kwargs))
            return False
