...
class Configuration:
    ...
    def description(self, name):
        """Vrať popis volby 'name' jako řetězec (může být i víceřádkový)."""
        import inspect
        # Musíme použít inspect, protože jinak nejsou dokumentační řetězce k
        # dispozici v optimalizovaném režimu...
