...
class Counter:
    ...
    Po svém vytvoření je inicializován na hodnotu 0 a při každém čtení metodou
    'next()' je tato hodnota zvýšena.
...
class XStack(Stack):
    ...
    V zásobníku nesmí být přítomen jeden objekt současně vícekrát.  V takovém
    případě není chování zásobníku definováno.
    ...
    def remove(self, item):
        ...
        Pokud byl vyjmutý prvek aktivním prvkem, je aktivován předcházející
        prvek.
...
def gettext_(text):
    """Vrať přeložený text jako unicode řetězec.

    Funkce také zachovává hodnotu None, je-li předána na vstupu.
...
def remove_duplicates(list):
    ...
    Funkce nezachovává pořadí prvků.
