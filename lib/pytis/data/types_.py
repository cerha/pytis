...
class LTree(Type):
    ...
    _VM_LONG_ITEM_MSG = _("Některá z hierarchických položek je příliš dlouhá")
    VM_INVALID_ITEM = 'VM_INVALID_ITEM'
    _VM_INVALID_ITEM_MSG = _("Některá z hierarchických položek obsahuje nepovolené znaky")
