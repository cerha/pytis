...
import pytis.data
from pytis.dbdefs import CmsRoles, cms_rights, cms_rights_rw, cms_schemas, cms_users_table
...
class CmsUserRoleAssignment(sql.SQLTable):
    ...
    fields = (
              ...
              sql.Column('uid', pytis.data.Integer(not_null=True), references=sql.gA(cms_users_table.value(globals()), ondelete='CASCADE')),
...
class CmsSessionLogData(sql.SQLTable):
    ...
    fields = (
              ...
              sql.Column('uid', pytis.data.Integer(not_null=False), references=sql.gA(cms_users_table.value(globals()), ondelete='CASCADE')),
