...
def run():
    ...
    menu[0]._items = ((pytis.form.Menu(_(u"Správa menu a uživatelských rolí"),
                                       (pytis.extensions.run_form_mitem(_(u"Menu"), 'menu.ApplicationMenu',
                                                                        pytis.form.BrowseForm),
                                        pytis.extensions.run_form_mitem(_(u"Práva menu"), 'menu.ApplicationMenuM',
                                                                        pytis.form.MultiBrowseDualForm),
                                        pytis.extensions.run_form_mitem(_(u"Uživatelské role"), 'menu.ApplicationRoles',
                                                                        pytis.form.MultiBrowseDualForm),
                                        pytis.extensions.run_procedure_mitem(_(u"Aplikace změn práv"),
                                                                             'menu.ApplicationMenuRights', 'commit_changes'),
                                        pytis.form.MItem(_(u"Přenačtení menu a práv"),
                                                         command=pytis.form.Application.COMMAND_RELOAD_RIGHTS),
                                        )),)
                      + menu[0]._items)
    top = Menu(name=None, title=_(u"CELÉ MENU"), parent=None, position='2', action=None, system=True)
    menu_items = {}
    actions = {}
    rights = {}
