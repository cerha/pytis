...
class ViewRelation(object):
    """Úložná třída specifikace relace view."""
    def __init__(self, relname, alias=None,
        ...
        """Specifikace joinu relace s předchozími relacemi.
        Argumenty:
...
class _GsqlViewNG(_GsqlSpec):
    ...
    def __init__(self, name, relations, include_columns=(),
        ...
        Argumenty:
          ...
          relations -- sekvence instancí třídy ViewRelation
          ...
          delete -- specifikace akce nad view při provedení operace DELETE.
            ...
            view.
          insert_order -- None nebo sekvence názvů ViewRelation. Pokud je None,
            ...
            budou provedeny v uvedeném pořadí. Vynecháním názvu ViewRelation
            se docílí toho, že insert pro danou relaci nebude vůbec proveden.
          update_order -- None nebo sekvence názvů ViewRelation. Pokud je None,
          ...
          delete_order -- None nebo sekvence názvů ViewRelation. Pokud je None,
