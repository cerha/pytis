...
class ApplicationMenu(pytis.presentation.Specification):
    ...
    fields = (
        ...
        Field('actionid', _("Navěšená akce"), codebook='menu.ApplicationActions'),
        Field('action', _("Navěšená akce")),
        )
    ...
    bindings = {'menu.ApplicationMenuRights':
                    pytis.presentation.BindingSpec(title=_("Práva položky menu"), binding_column='menuid')
                }
